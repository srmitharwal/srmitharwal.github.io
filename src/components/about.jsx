        ...
        <div className="colorlib-narrow-content">
            ...
            <div className="col-md-4 text-center animate-box">
                ...
                <div className="desc">
                    ...
                    <p>I have strong research experience in building scalable distributed products using Java, Microservice,SpringBoot.</p>
                </div>
                </div>
            </div>
            <div className="col-md-4 text-center animate-box">
                ...
                <div className="desc">
                    ...
                    <p>As coming from the CS background, I have strong grasp over fundamental concepts of DSA.</p>
                </div>
                </div>
            </div>
            <div className="col-md-4 text-center animate-box">
                ...
                <div className="desc">
                    ...
                    <p>I have recenlty found a new love in Web Development. Recenlty started exploring it.
                        This portfolio is also part of the same.
                    </p>
                </div>
                </div>
            </div>
